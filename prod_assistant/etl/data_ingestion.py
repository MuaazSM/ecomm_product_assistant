...
class DataIngestion:
    """
    class to handle data transformation and ignestion into a AstraDB vector store
    """
    ...
    def store_in_vector_db(self,  documents: List[Document]):
        ...
        print(f"inserted {len(inserted_ids)} docs into AstraDB")
    ...
    def run_pipeline(self):
        ...
        query = "tell me the low budget macbook"
